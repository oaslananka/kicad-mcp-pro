...
Additional NVIDIA NIM records are versioned as nonblocking replacement
candidates: `meta/llama-3.3-70b-instruct`, `minimaxai/minimax-m3`, and
`qwen/qwen3-next-80b-a3b-instruct`. Each candidate must pass protected smoke and
