...
def build_chat_payload(
    *,
    ...
    system = (
        ...
        "tool names. Select the smallest sufficient tool set. When one catalog tool fully "
        "satisfies the request, do not add narrower overlapping follow-up tools unless the "
        "user explicitly asks for those focused checks. For requests to inspect, summarize, "
        "overview, or review an object, when a "
    ...
    elif model in _MINIMAX_MODEL_ALIASES:
