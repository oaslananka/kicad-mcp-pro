...
def build_chat_payload(
    *,
    ...
    system = (
        ...
        "corresponding gate. Saying immediately or do not ask questions is not confirmation, "
        "and absent evidence is not approval.\n"
        ...
        "Missing destructive confirmation must be confirmation, not refusal. If the request "
        ...
        "tool names. This includes read-only inspect, summarize, or review requests and "
        "explicitly authorized destructive, export, or publish requests.\n"
