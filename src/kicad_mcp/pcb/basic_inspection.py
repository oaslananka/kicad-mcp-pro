...
class PcbBasicInspectionService:
    ...
    def get_nets(self) -> str:
        ...
        try:
            nets, total = self.limit_items(self._board().get_nets(netclass_filter=None))
    ...
    def get_zones(self) -> str:
        ...
        try:
            zones, total = self.limit_items(self._board().get_zones())
        except self.connection_errors as exc:
    ...
    def get_shapes(self) -> str:
        ...
        shapes, total = self.limit_items(self._board().get_shapes())
        if not shapes:
