    ...
    "schematic_edit": {
      ...
      "capabilities": [
        ...
        },
        {
          ...
          "status": "covered",
          "kicad_version_introduced": "10.0.x",
          "notes": "sch_add_global_label, sch_add_hierarchical_label, sch_move_label, sch_delete_label."
        },
        {
    ...
    "library": {
      ...
      "capabilities": [
        ...
        },
        {
          ...
          "status": "partial",
          "kicad_version_introduced": "10.0.x",
          "notes": "Footprint family coverage is limited (work order K10: SOT-23 implemented, SOT-223/SOT-89 not yet); datasheet/IPC validation hard-gate is Phase 4 (P4-T3)."
        },
        {
